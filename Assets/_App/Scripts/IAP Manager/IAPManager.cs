...
public class IAPKey
{
    public const string PACK1 = "nhac_thien_add10";
    public const string PACK2 = "nhac_thien_add20";
    public const string PACK3 = "nhac_thien_add50";
    public const string PACK4 = "nhac_thien_add100";
}
